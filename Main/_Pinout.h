...
number    pins         description                        Brd Jumpers /Labels                                                                  User (Fill in chart with user PIN usage)
          1             3v3                               PWR 3V3                                                                              3V3
          2             gnd                               GND                                                                                  GND
15        3             GPIO15/AD2_3/T3/SD_CMD/           D15 (has connections in both 5V and 3V areas)                                        Sonar Servo
2         4             GPIO2/AD2_2/T2/SD_D0              D2(has connections in both 5V and 3V areas)  /INDICATORLED ( On ESP32 board )        Status LED
4         5             GPIO4/AD2_0/T0/SD_D1              D4(has connections in both 5V and 3V areas)                                          Left Motor, Channel A
16        6             GPIO16/RX2                        Slide Switch S1b                                                                     
...
32        21            GPIO32/AD1_4/T9                   Potentiometer R1 / AD4                                                               Winch Motor
33        22            GPIO33/AD1_5/T8                   IMon/D33  monitor board current                                                      Lock Servo
25        23            GPIO25/AD2_8/DAC1                 SK6812 Smart LEDs / D25                                                              Smart LEDs
26        24            GPIO26/A2_9/DAC2                  Push Button PB2                                                                      Ultrasound Trigger
27        25            GPIO27/AD2_7/T7                   Push Button PB1                                                                      Push Button
...
#define pinUStrig      23  //grey lead -- Trigger
#define pinUSecho      26  //white lead -- Echo
...
#define pinSmartLED    25   //smart LEDS on MSEduino
#define pinStatusLED   2    //status LED on esp32 board
